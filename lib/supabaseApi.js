...
export const updateSupabasePresence = (firebaseIdToken, status) =>
  callSupabaseApi("presence/update", firebaseIdToken, { status });

export const getSupabasePresence = (firebaseIdToken, legacyUserIds) =>
  callSupabaseApi("presence/list", firebaseIdToken, { legacyUserIds });
