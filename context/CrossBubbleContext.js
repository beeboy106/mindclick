...
export const SHOP_AVATARS = [
  {
    id: "shop_blueberry",
    name: "บลูเบอร์รี่สดใส (Blueberry)",
    cost: 50,
    desc: "อวาตารผลไม้บลูเบอร์รี่สุดน่ารัก สดใสและขี้เล่น",
  },
  {
    id: "shop_red_apple",
    name: "แอปเปิ้ลจอมซ่า (Red Apple)",
    cost: 60,
    desc: "อวาตารแอปเปิ้ลสีแดงสุดกวน ส่งต่อพลังบวกและรอยยิ้ม",
  },
  {
    id: "shop_green_apple",
    name: "แอปเปิ้ลเขียวทะเล้น (Green Apple)",
    cost: 60,
    desc: "อวาตารแอปเปิ้ลเขียวแลบลิ้น อารมณ์ดีและมีชีวิตชีวา",
  },
  {
    id: "shop_funny_cat",
    name: "แมวส้มตาโต (Goofy Orange Cat)",
    cost: 80,
    desc: "น้องแมวส้มหน้าตาสุดกวน สร้างรอยยิ้มและเสียงหัวเราะ",
  },
  {
    id: "shop_curious_cat",
    name: "แมวขี้สงสัย (Curious Cat)",
    cost: 80,
    desc: "น้องแมวช่างคิดพร้อมเครื่องหมายคำถาม สงสัยใคร่รู้ทุกสิ่ง",
  },
  {
    id: "shop_shrimp_chicken",
    name: "ไก่กุ้งกรอบ (Crispy Shrimp Chicken)",
    cost: 100,
    desc: "สิ่งมีชีวิตลูกผสมสุดปั่น ตัวเป็นกุ้งหัวเป็นไก่ น่ารักไม่ซ้ำใคร",
  },
  {
    id: "shop_pink_shrimp_chicken",
    name: "ไก่กุ้งซากุระ (Pink Shrimp Chicken)",
    cost: 100,
    desc: "ไก่กุ้งสีชมพูพาสเทล หวานแหววและแปลกใหม่อย่างมีสไตล์",
  },
  {
    id: "shop_cyber_flame",
    name: "ไซเบอร์เฟลม (Cyber Flame)",
    cost: 120,
    desc: "เปลวเพลิงไซเบอร์สุดเท่ เปล่งประกายพลังงานความมุ่งมั่นและความร้อนแรง",
  },
  {
    id: "shop_soul_flame",
    name: "โซลเฟลม (Soul Flame)",
    cost: 120,
    desc: "เปลวเพลิงวิญญาณสไตล์มินิมอล ลึกลับ อบอุ่น และทรงพลัง",
  },
];
